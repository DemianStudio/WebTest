...
<fmt:formatDate value="${article.regDate }" pattern="yyyy년 MM월 dd일 HH시"
		var="regDate" />
<fmt:formatDate value="${article.updateDate }"
		pattern="yyyy년 MM월 dd일 HH시" var="updateDate" />
<section class="mt-5">
		<div class="container mx-auto px-3">
														...
														<div class="flex items-center">
																...
																<c:if test="${actorCanMakeReaction}">
																		<a
																				...
																				class="btn btn-xs btn-outline btn-primary"> 좋아요
																				👍 </a>
																		<span>&nbsp;</span>
																		<a
				...
				<div class="btns">
						...
						<c:if test="${not empty param.listUri}">
								<button class="btn btn-link" type="button"
										onclick="${param.listUri}">뒤로가기</button>
						</c:if>
												...
												<tr>
														...
														<td>
																<textarea class="w-full textarea textarea-bordered"
																		name="body" placeholder="내용"></textarea>
														</td>
												</tr>
												<tr>
														<th>댓글작성</th>
						...
						<tbody>
								...
								<c:forEach var="reply" items="${replies}">
										<fmt:formatDate value="${reply.regDate }"
												pattern="MM월dd일 HH:mm" var="regDate" />
										<fmt:formatDate value="${reply.updateDate }"
												pattern="MM월dd일 HH:mm" var="updateDate" />
										<tr class="hover">
												<th>${reply.id}</th>
												<td>${regDate}</td>
												<td>${updateDate}</td>
